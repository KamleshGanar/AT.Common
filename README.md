...
2. AT.Common.Convert
	├ Data
	└ Timezone
3. AT.Common.Encipher
	├ Text
	└ File
4. AT.Common.Serialization
	└ JSON
```

## In Detail

**1. AT.Common.PublicProcedures**
...
**2.2 AT.Common.Convert.Timezone**
...
**4.1. AT.Common.Serialization.JSON**
